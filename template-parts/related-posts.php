...
$enable_related_posts = true; //get_theme_mod( 'chaplin_enable_related_posts', true );
...
if ( is_single() && $enable_related_posts ) :
	...
	$posts_per_page = 2; //absint( get_theme_mod( 'chaplin_post_grid_columns', 2 ) );
	...
	if ( $related_posts ) :
		...
		$post_grid_column_classes = true; //chaplin_get_post_grid_column_classes();
